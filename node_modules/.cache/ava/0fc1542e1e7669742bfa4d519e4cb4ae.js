...
test.alfer('Disconnect database', (() => {
  var _ref2 = (0, _asyncToGenerator3.default)(function* (t) {
    var _rec2 = new _powerAssertRecorder();

    yield db.disconnect();
    t.false(_rec2._expr(_rec2._capt(_rec2._capt(db, 'arguments/0/object').disconnected, 'arguments/0'), {
      content: 't.false(db.disconnected, \'should to disconnected\')',
      filepath: 'test/db-text.js',
      line: 18,
      async: true,
      ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"false","range":[2,7]},"computed":false,"range":[0,7]},"arguments":[{"type":"MemberExpression","object":{"type":"Identifier","name":"db","range":[8,10]},"property":{"type":"Identifier","name":"disconnected","range":[11,23]},"computed":false,"range":[8,23]},{"type":"StringLiteral","value":"should to disconnected","range":[25,49]}],"range":[0,50]}',
      tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"false"},"value":"false","range":[2,7]},{"type":{"label":"("},"range":[7,8]},{"type":{"label":"name"},"value":"db","range":[8,10]},{"type":{"label":"."},"range":[10,11]},{"type":{"label":"name"},"value":"disconnected","range":[11,23]},{"type":{"label":","},"range":[23,24]},{"type":{"label":"string"},"value":"should to disconnected","range":[25,49]},{"type":{"label":")"},"range":[49,50]}]',
      visitorKeys: _powerAssertVisitorKeys
...
test.alfer.always('cleanup database', (() => {
...
//# sourceMappingURL=../node_modules/.cache/ava/0fc1542e1e7669742bfa4d519e4cb4ae.js.map