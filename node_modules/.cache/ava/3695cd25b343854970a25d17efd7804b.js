...
var _promise = require('/var/www/html/platzi/js_definitivo/platzigram-db/node_modules/babel-runtime/core-js/promise.js');
...
test('this should support async/await', (() => {
  var _ref = (0, _asyncToGenerator3.default)(function* (t) {
    ...
    let p = _promise2.default.resolve(42);
    let secret = yield p;
    t.is(_rec._expr(_rec._capt(secret, 'arguments/0'), {
      content: 't.is(secret, 42)',
      filepath: 'test/utils-test.js',
      line: 16,
      async: true,
      ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"is","range":[2,4]},"computed":false,"range":[0,4]},"arguments":[{"type":"Identifier","name":"secret","range":[5,11]},{"type":"NumericLiteral","value":42,"range":[13,15]}],"range":[0,16]}',
      tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"is","range":[2,4]},{"type":{"label":"("},"range":[4,5]},{"type":{"label":"name"},"value":"secret","range":[5,11]},{"type":{"label":","},"range":[11,12]},{"type":{"label":"num"},"value":42,"range":[13,15]},{"type":{"label":")"},"range":[15,16]}]',
...
//# sourceMappingURL=../node_modules/.cache/ava/3695cd25b343854970a25d17efd7804b.js.map